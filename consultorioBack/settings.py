"""
Django settings for consultorioBack project.
...
SECRET_KEY = "django-insecure-cvquhob^9z2*k04^*#)@m#pq6kps1oe#2n9%db^&nx^1bq7@fd"
...
ROOT_URLCONF = "consultorioBack.urls"
...
WSGI_APPLICATION = "consultorioBack.wsgi.application"
